...
`.github/workflows/ci.yml` corre los 28 modos en cada pull request, después de compilar y **antes** del
paso de cobertura.
...
Medido: 14.5 s el build y **8.1 s los 28 modos** en local; en el runner el paso agregó **26 segundos**

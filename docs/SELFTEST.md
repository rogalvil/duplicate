...
| `cache-liveness --cache` | Solo lectura sobre la caché **real**: cuántas filas describen un archivo que existe. Hoy 7,741 filas, 3,421 vivas, 4,320 muertas, **55.8% de desperdicio**, 0 irresolubles, 0 en volumen desmontado. Y afirma que las clases suman | necesita una caché real; sin `--cache` usa la default y salta si no hay |
